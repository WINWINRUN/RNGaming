...
local TycoonConfigSource = [[local TycoonConfig = {
...
local MainServerSource = [[local ReplicatedStorage = game:GetService("ReplicatedStorage")
local ServerScriptService = game:GetService("ServerScriptService")
...
local TycoonServiceSource = [[local Players = game:GetService("Players")
local ReplicatedStorage = game:GetService("ReplicatedStorage")
local ServerScriptService = game:GetService("ServerScriptService")
...
local TycoonClientSource = [[local Players = game:GetService("Players")
local ReplicatedStorage = game:GetService("ReplicatedStorage")
...
local function replaceWithClass(parent, childName, className, source)
...
replaceWithClass(ReplicatedStorage, "Config", "ModuleScript", ConfigSource)
replaceWithClass(ReplicatedStorage, "TycoonConfig", "ModuleScript", TycoonConfigSource)
replaceWithClass(ServerScriptService, "MainServer", "Script", MainServerSource)
replaceWithClass(ServerScriptService, "TycoonService", "ModuleScript", TycoonServiceSource)
replaceWithClass(StarterPlayerScripts, "TycoonClient", "LocalScript", TycoonClientSource)
print("[RNGaming] Synced Among Us tycoon scripts into the open place")
