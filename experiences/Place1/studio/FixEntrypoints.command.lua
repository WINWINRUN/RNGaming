...
local function renderShop(shopData)
    ...
    for _, item in ipairs(shopData.Items or {}) do
        ...
        itemName.Position = UDim2.fromOffset(34, 12)
        itemName.Size = UDim2.new(1, -180, 0, 26)
        ...
        itemDescription.Position = UDim2.fromOffset(34, 40)
        itemDescription.Size = UDim2.new(1, -200, 0, 38)
...
replaceWithClass(ServerScriptService, "MainServer", "Script", serverSource)
local starterScripts = StarterPlayer:WaitForChild("StarterPlayerScripts")
replaceWithClass(starterScripts, "MainClient", "LocalScript", clientSource)

print("[RNGaming] Fixed MainServer/MainClient script classes in the open place")
