return {
    gameplay_prompt = "40-player waiting in line game where everyone locks to one tile, earns more credits closer to the front, pays more to advance, and meets the host at the finale",
    world_prompt = "blocky neon sci-fi queue district with one long main route, bright checkpoints, and a front stage",
    ...
    gameplay_spec = {
        ...
        source_prompt = "40-player waiting in line game where everyone locks to one tile, earns more credits closer to the front, pays more to advance, and meets the host at the finale",
        finale_role = "host"
    },
    world_binding = {
    ...
    world_result = {
        prompt = "blocky neon sci-fi queue district with one long main route, bright checkpoints, and a front stage",
        explicit_config = {
            theme = {
                value = "sci-fi",
                evidence = "sci-fi"
    ...
    gameplay_pipeline_steps = {
        ...
        "Allocate 5 gameplay zones across 48 modular world slots.",
        "Bind rewards to Credits using the jackpot-finale reward curve and cost-gate gating.",
        "Route players with checkpoint-forward motion and one-per-slot occupancy rules.",
    ...
    runtime_display = {
        ...
        goal_text = "Claim a spot, earn Credits, pay to move ahead, and meet the host at the front.",
        queue_intro_text = "Blocky Sci Fi layout with 40 player capacity and Credits progression.",
