# Mushroom Ruins Expanse Install And Usage

Mushroom Ruins Expanse uses a terrain-first architecture:
...
```powershell
python tools\review_terrain_profiles.py --project ".\Mushroom Ruins Expanse"
python tools\render_terrain_preview.py --project ".\Mushroom Ruins Expanse"
```
