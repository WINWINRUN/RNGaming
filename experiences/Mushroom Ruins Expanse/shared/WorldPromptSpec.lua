return {
    prompt = "giant mushroom forest at the pinnacle of a mountain within three mountain ranges with two valleys and a lake near the bottom, surrounded by sci-fi robot giant ruins from ancient civilization",
    explicit_config = {
        theme = {
            value = "ancient-tech",
        ...
        flora_style = {
            ...
            evidence = "mushroom forest"
        },
        mountain_range_count = {
            value = 3,
            evidence = "three mountain ranges"
        },
        valley_count = {
            value = 2,
            evidence = "two valleys"
        },
        landmarks = {
            value = {
                "mushroom_grove",
            ...
            evidence = "mushroom forest, robot giant ruins, giant ruins, ancient civilization, pinnacle, valley, lake"
        },
        water_feature = {
            value = "lake",
            evidence = "lake"
